Proceso  Indice_demasa_corporal
	Escribir "ALGORITMO IMC D EUNA PERSONA";
	Escribir "Autor: Brandon Eduardo Mendoza Castillo";
	Escribir "***************************************";
	Escribir  "Algoritmo que calcula el indice de masa corporal de una persona en base masa y talla" ;
	Escribir  "-----------------------------------------------------------" ;
